        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('users.update',$user->id)}}" method="POST" id="demo-form2"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" value="{{$user->fullName}}" name="fullName"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="status" @checked($user->status) class="flat">
                                    </label>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" value="{{$user->password}}"
                                    for="password">Password <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="password" id="password"  value="{{$user->password}}"name="password" required="required"
                                        class="form-control">
                                </div>
                            </div>
