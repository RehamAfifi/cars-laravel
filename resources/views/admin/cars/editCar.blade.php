        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('cars.update',$car->id)}}" method="POST" id="demo-form2"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="title" name="carTitle" value={{$car->carTitle}}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="luggage" class="form-control" value={{$car->luggages}} type="number"
                                    name="luggages" required="required">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label for="doors" class="col-form-label col-md-3 col-sm-3 label-align">Doors <span
                                        class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="doors" class="form-control" type="number" value={{$car->doors}}
                                    name="doors" required="required">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="passengers" class="form-control" type="number" value={{$car->passengers}}
                                    name="passengers" required="required">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label for="price" class="col-form-label col-md-3 col-sm-3 label-align">Price <span
                                        class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="price" class="form-control" type="number" value={{$car->price}}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="flat" name="active" value="active"
                                            @checked($car->active)>
                                    </label>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <img src="{{asset('assets/images/cars/'. $car->image)}}" alt="{{$car->carTitle}}"
                                        style="width: 300px;">
                                </div>
                            </div>
