  ...
  <head>
	...
	<!-- bootstrap-wysiwyg -->
	<link href="{{asset('admin/assets/vendors/google-code-prettify/bin/prettify.min.css')}}" rel="stylesheet">
	<!-- Select2 -->
	...
	<!-- starrr -->
	<link href="{{asset('admin/assets/vendors/starrr/dist/starrr.css')}}" rel="stylesheet">
