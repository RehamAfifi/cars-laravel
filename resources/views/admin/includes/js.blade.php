...
<!-- bootstrap-wysiwyg -->
<script src="{{asset('admin/assets/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js')}}"></script>
<script src="{{asset('admin/assets/vendors/jquery.hotkeys/jquery.hotkeys.js')}}"></script>
<script src="{{asset('admin/assets/vendors/google-code-prettify/src/prettify.js')}}"></script>
<!-- jQuery Tags Input -->
...
<!-- Parsley -->
<script src="{{asset('admin/assets/vendors/parsleyjs/dist/parsley.min.js')}}"></script>
<!-- Autosize -->
<script src="{{asset('admin/assets/vendors/autosize/dist/autosize.min.js')}}"></script>
<!-- jQuery autocomplete -->
<script src="{{asset('admin/assets/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js')}}"></script>
<!-- starrr -->
<script src="{{asset('admin/assets/vendors/starrr/dist/starrr.js')}}"></script>
