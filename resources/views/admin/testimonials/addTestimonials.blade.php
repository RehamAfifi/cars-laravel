...
@section('pageTitle','Add Testimonials')
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" action="{{route('testimonials.store')}}" id="demo-form2"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <textarea id="content" name="content" value="{{old('content')}}" required="required"
